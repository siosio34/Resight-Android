...
public class BluetoothHandService {
    // Debugging
     ...
     */
    public BluetoothHandService(Context context, Handler handler) {
    ...
    private void connectionFailed() {
        ...
        BluetoothHandService.this.start();
    }
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (BluetoothHandService.this) {
                        switch (mState) {
                            case STATE_LISTEN:
